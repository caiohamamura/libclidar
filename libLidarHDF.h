...
int write1dInt64HDF5(hid_t,char *,int64_t *,int);
int write1dUint32HDF5(hid_t,char *,uint32_t *,int);
int write1dUint16HDF5(hid_t,char *,uint16_t *,int);
int write2dUint16HDF5(hid_t,char *,uint16_t *,int,int);
int writeComp2dInt8HDF5(hid_t,char *,int8_t *,int,int);
int writeComp2dFloatHDF5(hid_t,char *,float *,int,int);
int writeComp1dFloatHDF5(hid_t,char *,float *,int);
int writeComp1dUint8HDF5(hid_t,char *,uint8_t *,int);
int writeComp1dUint16HDF5(hid_t,char *,uint16_t *,int);
int writeComp1dUint32HDF5(hid_t,char *,uint32_t *,int);
int writeComp1dUint64HDF5(hid_t,char *,uint64_t *,int);
int writeComp1dInt8HDF5(hid_t,char *,int8_t *,int);
int writeComp1dInt32HDF5(hid_t,char *,int32_t *,int);
int writeComp1dDoubleHDF5(hid_t,char *,double *,int);
