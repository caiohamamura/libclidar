...
lvisHDF *readLVIShdf(char *inNamen)
{
  ...
  if(lvis->wave)
    return(NULL);
  if(checkNumber(nWaves,lvis->nWaves,"RXWAVE")!=0)
    return(NULL);
  /*if there is a pulse*/
